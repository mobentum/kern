...
## Optional package (`github.com/mobentum/kern/extensions/openapi`)

### `openapi.Register(app, config)`
...
- Apply route-specific guards with `RouteWithMiddleware` / `RouteNamedWithMiddleware`.
