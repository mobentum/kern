            ...
            <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8">
                    ...
                    <h1 className="text-5xl lg:text-7xl font-bold tracking-tight">
                        <span className="text-white">A fast Go</span>
                        <br />
                        <span className="text-white">web framework</span>
                        <br />
                    ...
                    <p className="text-lg lg:text-xl text-slate-400 max-w-xl leading-relaxed">
                        Kern is a fast, zero-dependency Go HTTP framework with
                        stdlib-native routing, context pooling, built-in
                        middleware, and graceful shutdown — designed for
                        production APIs without the bloat.
                    </p>

                    <div className="flex flex-wrap gap-4">
                        <Link
                            href="/docs"
                            className="group relative inline-flex items-center gap-2 px-6 py-3 bg-violet-600 hover:bg-violet-500 text-white font-semibold rounded-lg transition-all shadow-lg shadow-violet-500/20 hover:shadow-violet-500/40"
                        >
                            Read the docs
                            <svg
                ...
                <div className="relative">
                    {/* Floating orbs */}
                    <div className="absolute -top-8 -right-4 w-64 h-64 bg-violet-500/12 rounded-full blur-3xl"></div>
                    <div className="absolute top-12 -right-8 w-56 h-56 bg-indigo-500/10 rounded-full blur-3xl"></div>
                    <div className="absolute top-32 right-8 w-48 h-48 bg-cyan-500/10 rounded-full blur-2xl"></div>
