...
var (
	ErrEmptyAddress      = errors.New("grpcx: addr is required")
	ErrNilRegistration   = errors.New("grpcx: registration function is nil")
	ErrHealthNotEnabled  = errors.New("grpcx: health service is not enabled")
)
...
func New(cfg Config, regs ...Registration) (*Server, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("grpcx: listen: %w", err)
	}
